...
class MineRouter extends IRouterProvider{
  ...
  void initRouter(Router router){
    ...
    router.define(userDetailsPage, handler: Handler(handlerFunc: (_, __) => ProfileDetailsPage()));
    router.define(editProfilePage, handler: Handler(handlerFunc: (_, __) => EditProfilePage()));
  }
}